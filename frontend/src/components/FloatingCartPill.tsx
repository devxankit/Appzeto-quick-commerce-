...
export default function FloatingCartPill() {
  ...
  // Hide pill on checkout pages, order pages, and account page
  ...
  const shouldHidePill = isCheckoutPage || isOrderPage || isAccountPage;
