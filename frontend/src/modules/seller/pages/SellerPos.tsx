                    ...
                    <div className="flex-shrink-0 bg-neutral-50 p-4 border-t border-neutral-200">
                            ...
                            <div className="space-y-3">
                                <button 
                                    ...
                                    className="w-full bg-green-600 hover:bg-green-700 text-white py-3 rounded text-sm font-medium flex justify-center items-center gap-2 shadow-sm transition-colors"
                                >
