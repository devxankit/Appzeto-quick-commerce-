...
export default function DashboardCard({ icon, title, value, accentColor }: DashboardCardProps) {
  return (
    <div className="bg-white rounded-xl p-4 shadow-sm flex flex-col items-center justify-center min-h-[120px] border border-neutral-200 hover:shadow-md transition-shadow">
